...
/******/ 		return __webpack_require__.p + "" + ({"vendors~views-AboutUs-AboutUs-test~views-App-App-test~views-ContactUs-ContactUs-test~views-ErrorBoun~6f19bab9":"vendors~views-AboutUs-AboutUs-test~views-App-App-test~views-ContactUs-ContactUs-test~views-ErrorBoun~6f19bab9","views-AboutUs-AboutUs-test":"views-AboutUs-AboutUs-test","views-App-App-test":"views-App-App-test","views-ContactUs-ContactUs-test":"views-ContactUs-ContactUs-test","views-ErrorBoundary-ErrorBoundary-test":"views-ErrorBoundary-ErrorBoundary-test","views-Footer-Footer-test":"views-Footer-Footer-test","views-Header-Header-test":"views-Header-Header-test","views-Home-Home-test":"views-Home-Home-test","views-NotFound-NotFound-test":"views-NotFound-NotFound-test","views-AboutUs":"views-AboutUs","views-AboutUs-AboutUsComponent":"views-AboutUs-AboutUsComponent","views-AboutUs-__snapshots__-AboutUs-test-js-snap":"views-AboutUs-__snapshots__-AboutUs-test-js-snap","views-App-__snapshots__-App-test-js-snap":"views-App-__snapshots__-App-test-js-snap","views-ContactUs":"views-ContactUs","views-ContactUs-ContactUsComponent":"views-ContactUs-ContactUsComponent","views-ContactUs-__snapshots__-ContactUs-test-js-snap":"views-ContactUs-__snapshots__-ContactUs-test-js-snap","views-ErrorBoundary-ErrorBoundaryType":"views-ErrorBoundary-ErrorBoundaryType","views-ErrorBoundary-__snapshots__-ErrorBoundary-test-js-snap":"views-ErrorBoundary-__snapshots__-ErrorBoundary-test-js-snap","views-Footer-__snapshots__-Footer-test-js-snap":"views-Footer-__snapshots__-Footer-test-js-snap","views-Header-__snapshots__-Header-test-js-snap":"views-Header-__snapshots__-Header-test-js-snap","views-Home":"views-Home","views-Home-HomeComponent":"views-Home-HomeComponent","views-Home-__snapshots__-Home-test-js-snap":"views-Home-__snapshots__-Home-test-js-snap","views-NotFound-__snapshots__-NotFound-test-js-snap":"views-NotFound-__snapshots__-NotFound-test-js-snap"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
...
/******/ 	deferredModules.push(["./client/index.tsx","vendor"]);
...
/* harmony import */ var _shared_views_App__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/views/App */ "./shared/views/App/index.js");
...
if (false) { var renderApp; } else {
  if (rootElement === null) {
    throw new Error('Element with id #root is not found.  ');
  }

  Object(_loadable_component__WEBPACK_IMPORTED_MODULE_0__["loadableReady"])(function () {
    Object(react_dom__WEBPACK_IMPORTED_MODULE_2__["hydrate"])(react__WEBPACK_IMPORTED_MODULE_1__["createElement"](react_router_dom__WEBPACK_IMPORTED_MODULE_3__["BrowserRouter"], null, react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_shared_views_App__WEBPACK_IMPORTED_MODULE_4__["default"], null)), rootElement);
  });
}
...
var routes = [];
_data_views_schema_routes__WEBPACK_IMPORTED_MODULE_1__["ROUTES"].forEach(function (route) {
  var routeConfig = {
    component: Object(_loadable_component__WEBPACK_IMPORTED_MODULE_0__["default"])({
      chunkName: function chunkName() {
        return "views-".concat(route.componentName).replace(/[^a-zA-Z0-9_!§$()=\-^°]+/g, "-");
      },
      ...
      requireAsync: function requireAsync() {
        return __webpack_require__("./shared/views lazy recursive ^\\.\\/.*$")("./".concat(route.componentName));
      },
      ...
      resolve: function resolve() {
        if (true) {
          return /*require.resolve*/(__webpack_require__("./shared/views weak recursive ^\\.\\/.*$").resolve("./".concat(route.componentName)));
        }

        return eval('require.resolve')("../views/".concat(route.componentName));
      }
    }),
    exact: route.exact,
...
var map = {
	...
	"./AboutUs/AboutUs.test": [
		...
		9,
		"vendors~views-AboutUs-AboutUs-test~views-App-App-test~views-ContactUs-ContactUs-test~views-ErrorBoun~6f19bab9",
...
module.exports = {"wrapper":"shared-views-App-App__wrapper--TUJZM","page-specific-content":"shared-views-App-App__page-specific-content--28JU6"};
...
var AppComponent = function AppComponent() {
  return react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_ErrorBoundary__WEBPACK_IMPORTED_MODULE_5__["default"], null, react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", {
    ...
    className: "padding-all-15 ".concat(_App_scss__WEBPACK_IMPORTED_MODULE_4___default.a['page-specific-content'])
  }, react__WEBPACK_IMPORTED_MODULE_0__["createElement"](react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Switch"], null, "// TODO: Check if any type can be avoided below.", _routes__WEBPACK_IMPORTED_MODULE_9__["default"].map(function (_ref) {
    var path = _ref.path,
        exact = _ref.exact,
        C = _ref.component,
...
function (_React$Component) {
  ...
  function ErrorBoundaryComponent() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ErrorBoundaryComponent)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
// extracted by mini-css-extract-plugin
module.exports = {"footer":"shared-views-Footer-Footer__footer--1in89"};
...
var FooterComponent = function FooterComponent() {
  return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("footer", {
    className: "display-flex flex-items-align-center padding-all-15 ".concat(_Footer_scss__WEBPACK_IMPORTED_MODULE_3___default.a['footer'])
  }, react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("nav", null, react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("ul", {
    className: "display-flex"
  }, _data_views_schema_footer__WEBPACK_IMPORTED_MODULE_2__["FOOTER_LINKS"].map(function (footerLink) {
...
// extracted by mini-css-extract-plugin
module.exports = {"header":"shared-views-Header-Header__header--9ZI-n","logo":"shared-views-Header-Header__logo--3hYoV"};
...
var HeaderComponent = function HeaderComponent() {
  return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("header", {
    className: "display-flex flex-items-align-center padding-all-15 ".concat(_Header_scss__WEBPACK_IMPORTED_MODULE_3___default.a['header'])
    ...
    className: "width-100 ".concat(_Header_scss__WEBPACK_IMPORTED_MODULE_3___default.a['logo']),
    "data-test": "logo",
